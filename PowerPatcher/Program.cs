...
#if !DEBUG
			if (Properties.Settings.Default.WarnIfNotInMabiDir && (!string.Equals(Path.GetFullPath(nxdir), Path.GetFullPath(Environment.CurrentDirectory), StringComparison.OrdinalIgnoreCase)))
			{
